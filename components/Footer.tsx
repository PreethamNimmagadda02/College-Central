...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-t border-slate-200/60 dark:border-slate-800/60 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center md:items-start gap-4">
              <div className="flex items-center gap-3">
                <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-2.5 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="flex gap-4 mb-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-2.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 dark:hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="LinkedIn"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-2.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="GitHub"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href="mailto:preetham.code@gmail.com"
                  className="group p-2.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-gradient-to-br hover:from-red-500 hover:to-red-600 hover:text-white dark:hover:from-red-500 dark:hover:to-red-600 dark:hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="Gmail"
                >
        ...
        <div className="border-t border-slate-200/60 dark:border-slate-800/60 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-xs text-slate-500 dark:text-slate-400 text-center md:text-left">
              © {currentYear} College Central. All rights reserved.
            </p>
            <div className="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
              ...
              <span className="text-slate-300 dark:text-slate-700">•</span>
              <a
                href="mailto:support@collegecentral.com"
                className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
              >
                Support
              </a>
