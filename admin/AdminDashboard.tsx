...
// Editor Components
import CollegeInfoEditor from '@/admin/components/CollegeInfoEditor';
import BranchesEditor from '@/admin/components/BranchesEditor';
import HostelsEditor from '@/admin/components/HostelsEditor';
import QuickLinksEditor from '@/admin/components/QuickLinksEditor';
import QuotesEditor from '@/admin/components/QuotesEditor';
import FormsEditor from '@/admin/components/FormsEditor';
import CalendarEditor from '@/admin/components/CalendarEditor';
import DirectoryEditor from '@/admin/components/DirectoryEditor';
import CoursesEditor from '@/admin/components/CoursesEditor';
import StudentDirectoryEditor from '@/admin/components/StudentDirectoryEditor';
import CampusMapEditor from '@/admin/components/CampusMapEditor';
import AnalyticsEditor from '@/admin/components/AnalyticsEditor';
import SupportEditor from '@/admin/components/SupportEditor';
...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className={`admin-container min-h-screen flex flex-col ${sidebarOpen ? 'overflow-hidden h-screen' : ''}`}>
      {/* Header */}
      <header className="admin-header">
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button 
              onClick={adminConfig.resetToDefaults}
