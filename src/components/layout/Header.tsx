...
const Header: React.FC<HeaderProps> = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const { weather, weatherLoading, setShowWeatherModal } = useWeather();
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full bg-gradient-to-r from-white/95 via-slate-50/95 to-white/95 dark:from-slate-900/95 dark:via-slate-900/90 dark:to-slate-900/95 backdrop-blur-xl z-50 border-b border-slate-200/50 dark:border-slate-700/50 shadow-lg">
