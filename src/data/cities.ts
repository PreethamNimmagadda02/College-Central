...
export const cities: City[] = [
    ...
    { name: 'Bhilwara', state: 'Rajasthan', lat: 25.3470, lon: 74.6401 },
    ...
    { name: 'Brahmapur', state: 'Odisha', lat: 19.3150, lon: 84.7941 },
    ...
    { name: 'Tezpur', state: 'Assam', lat: 26.6338, lon: 92.8000 },
    ...
    { name: 'Pilani', state: 'Rajasthan', lat: 28.3670, lon: 75.6032 },
    { name: 'Roorkee', state: 'Uttarakhand', lat: 29.8543, lon: 77.8880 },
    { name: 'Kharagpur', state: 'West Bengal', lat: 22.3460, lon: 87.2320 },
    { name: 'Trichy', state: 'Tamil Nadu', lat: 10.7905, lon: 78.7047 },
    { name: 'Manipal', state: 'Karnataka', lat: 13.3500, lon: 74.7833 },
    ...
    { name: 'Hubballi-Dharwad', state: 'Karnataka', lat: 15.3647, lon: 75.1240 },
    ...
    { name: 'Mira Road', state: 'Maharashtra', lat: 19.2812, lon: 72.8640 },
